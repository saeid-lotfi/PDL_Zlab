...
os.makedirs('data/yolo_format/', exist_ok= True)

data_dir = '/data/generated/'
Dataset_names_path = "data/yolo_format/digit_names.txt"
Dataset_train = "data/yolo_format/digit_train.txt"
Dataset_test = "data/yolo_format/digit_test.txt"
is_subfolder = False
