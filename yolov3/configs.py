...
TRAIN_CLASSES               = "data/yolo_format/digit_names.txt"
TRAIN_ANNOT_PATH            = "data/yolo_format/digit_train.txt"
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = f"{YOLO_TYPE}_digit_localizer"
...
# TEST options
TEST_ANNOT_PATH             = "data/yolo_format/digit_train.txt"
TEST_BATCH_SIZE             = 10
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
